                            ...
                            <nav aria-label="..." style="text-align:center;">
                                <ul class="pagination">
                                    <li>
                                        ...
                                        <a href="javascript:ajaxsplit(${info1.current-1})" aria-label="Previous">

                                            <span aria-hidden="true">«</span></a>
                                    </li>
                                    <c:forEach begin="1" end="${pages}" var="i">
                                        <c:if test="${info1.current==i}">
                                            <li>
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:ajaxsplit(${info1.current+1})" aria-label="Next">
                                            <span aria-hidden="true">»</span></a>
                                    </li>
                                    <li style=" margin-left:150px;color: #0e90d2;height: 35px; line-height: 35px;">总共&nbsp;&nbsp;&nbsp;<font
                                            style="color:orange;">${pages}</font>&nbsp;&nbsp;&nbsp;页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <c:if test="${info1.current!=0}">
                                            当前&nbsp;&nbsp;&nbsp;<font
                                            style="color:orange;">${info1.current}</font>&nbsp;&nbsp;&nbsp;页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </c:if>
                                        <c:if test="${info1.current==0}">
                                            当前&nbsp;&nbsp;&nbsp;<font
...
<script type="text/javascript">
    ...
    <%--    location.href = "${pageContext.request.contextPath}/prod/one?pid=" + pid + "&page=" + ispage;--%>
    <%--}--%>

    function one(pid) {
        location.href = "${pageContext.request.contextPath}/prod/one?pid=" + pid;
    }
    ...
    function condition() {
        ...
        var hprice=$("#hprice").val();
            $.ajax({
                url: "${pageContext.request.contextPath}/prod/condition",
                data: {"pName":pname,"typeId":typeid,
                    "minPrice":lprice,"maxPrice":hprice},
                type: "post",
                success: function () {
                    $("#table").load("http://localhost:8080/admin/product.jsp #table");
                }
...
<script type="text/javascript">
    function ajaxsplit(page) {
        ...
        $.ajax({
            ...
            data: {"pName":pname,"typeId":typeid,
                "minPrice":lprice,"maxPrice":hprice,"page":page},
            type: "post",
            success: function () {
                //重新加载分页显示的组件table
